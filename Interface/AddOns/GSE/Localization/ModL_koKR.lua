...
L["/gse|r will list any macros available to your spec.  This will also add any macros available for your current spec to the macro interface."] = "/gse|r 전문화에 사용할 수 있는 모든 매크로를 나열합니다. 또한 현재 전문화에 사용할 수 있는 매크로가 매크로 인터페이스에 추가됩니다."
--[[Translation missing --]]
...
L["The GSE Out of Combat queue is %s"] = "GSE 비전투 중 대기열이 %"
--[[Translation missing --]]
